...
! function(e, t) {
      ...
      fn: function(e) {
        ...
        if(e = e.name, !t.modifiersData[e]._skip) {
          ...
          for(var d = c[0], l = 0; l < c.length; l++) {
            ...
            if(v = g ? v ? "right" : "left" : v ? "bottom" : "top", n[y] > r[y] && (v = j(v)), y = j(v), (h = [0 >= w[h], 0 >= w[v], 0 >= w[y]]).every((function(e) {
                return e
              }))) {
              d = m, p = !1;
              break
      ...
      fn: function(e) {
        ...
        if(s = {
          ...
          var O = d[u] + r[g],
            ...
            j = i ? -m[w] / 2 : 0,
            E = "start" === f ? l[w] : m[w];
          f = "start" === f ? -m[w] : -l[w], m = t.elements.arrow, m = i && m ? c(m) : {
            width: 0,
            height: 0
          };
          ...
          g = D[g], y = D[y], m = Math.max(0, Math.min(l[w], m[w])), E = p ? l[w] / 2 - j - m - g - v : E - m - g - v, p = p ? -l[w] / 2 + j + m + y + v : f + m + y + v, v = t.elements.arrow && h(t.elements.arrow), l = t.modifiersData.offset ? t.modifiersData.offset[t.placement][u] : 0, v = d[u] + E - l - (v ? "y" === u ? v.clientTop || 0 : v.clientLeft || 0 : 0), p = d[u] + p - l, i = Math.max(i ? Math.min(O, v) : O, Math.min(o, i ? Math.max(M, p) : M)), d[u] = i, s[u] = i - o
        }
  ...
  e.createPopper = z, e.defaultModifiers = V, e.popperGenerator = w, Object.defineProperty(e, "__esModule", {
    value: !0
  })
}));
